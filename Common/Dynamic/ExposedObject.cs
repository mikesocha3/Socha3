...
{
    /// <summary>
    /// Provides a dynamic-type  wrapper for accessing internal, private or protected members of an object
    /// </summary>
    public class ExposedObject : DynamicObject
    {
        ...
        private static ConstructorInfo GetConstructorInfo(Type type, params Type[] args)
        {
            ...
            throw new MissingMemberException(type.FullName, $".ctor({string.Join(", ", Array.ConvertAll(args, t => t.FullName))})");
        }
