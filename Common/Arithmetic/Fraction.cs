...
namespace Socha3.Common.Arithmetic
{
    /// <summary>
    /// Classes Contained:
    ///     Fraction
    ...
    public struct Fraction : IComparable, IFormattable
    {
        ...
        public Int32 ToInt32()
        {
            ...
            {
                throw new FractionException($"Cannot convert {IndeterminateTypeName(this.m_Numerator)} to Int32", new NotFiniteNumberException());
            }
        ...
        public Int64 ToInt64()
        {
            if (this.m_Denominator == 0)
            {
                throw new FractionException($"Cannot convert {IndeterminateTypeName(this.m_Numerator)} to Int64", new NotFiniteNumberException());
            }
