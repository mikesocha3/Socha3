...
using Socha3.BlinkStick.LibUsbDotNet.DeviceNotify;

namespace Socha3.BlinkStick
{
	public class UsbMonitor
	{
		...
		public UsbMonitor ()
		{
            switch (Socha3.BlinkStick.HidSharp.PlatformDetector.RunningPlatform())
            {
                case Socha3.BlinkStick.HidSharp.PlatformDetector.Platform.Windows:
                    winUsbDeviceMonitor = new WinUsbDeviceMonitor();
                    winUsbDeviceMonitor.DeviceListChanged += HandleDeviceListChanged;
                    break;
                case Socha3.BlinkStick.HidSharp.PlatformDetector.Platform.Linux:
