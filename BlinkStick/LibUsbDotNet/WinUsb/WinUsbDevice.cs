...
using Socha3.BlinkStick.LibUsbDotNet.Descriptors;
using Socha3.BlinkStick.LibUsbDotNet.Internal;
using Socha3.BlinkStick.LibUsbDotNet.Internal.WinUsb;
using Socha3.BlinkStick.LibUsbDotNet.Main;
using Socha3.BlinkStick.LibUsbDotNet.WinUsb.Internal;
using Microsoft.Win32.SafeHandles;

namespace Socha3.BlinkStick.LibUsbDotNet.WinUsb
{
    /// <summary> 
